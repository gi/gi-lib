...
#ifndef GI_LIBCXX_STRING_LITERAL_HPP_INCLUDED_
#define GI_LIBCXX_STRING_LITERAL_HPP_INCLUDED_
...
#include <gi/string_literal_fwd.hpp>
...
class basic_string_literal
    //! \cond
    : public boost::totally_ordered1< basic_string_literal< CharT, TraitsT >,
      boost::totally_ordered2< basic_string_literal< CharT, TraitsT >, const CharT*,
...
public:
    ...
    basic_string_literal(T(&p)[LenV]
        //! \cond
        , typename boost::enable_if< is_same< T, const value_type >, int >::type = 0
        //! \endcond
        ) BOOST_NOEXCEPT
     ...
     */
    template< typename T, size_type LenV >
#ifndef GI_LIBCXX_DOXYGEN_PASS
    typename boost::enable_if<
        boost::is_same< T, const value_type >,
        this_type&
    >::type
#else
    this_type&
#endif // GI_LIBCXX_DOXYGEN_PASS
...
//#ifdef GI_LIBCXX_USE_CHAR
template< typename T, std::size_t LenV >
inline
#ifndef GI_LIBCXX_DOXYGEN_PASS
typename boost::enable_if<
    boost::is_same< T, const char >,
    string_literal
>::type
#else
...
#endif // GI_LIBCXX_STRING_LITERAL_HPP_INCLUDED_
